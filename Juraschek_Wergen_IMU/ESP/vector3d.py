...
class Vector3d(object):
    ...
    def xyz(self):
        ...
        #x = self._calvector[self._transpose[0]] * self._scale[0]
        #y = self._calvector[self._transpose[1]] * self._scale[1]
        #z = self._calvector[self._transpose[2]] * self._scale[2]
        ...
        #return (round((self._calvector[self._transpose[0]] * self._scale[0]),5),
         #       round((self._calvector[self._transpose[1]] * self._scale[1]),5),
          #      round((self._calvector[self._transpose[2]] * self._scale[2]),5))
